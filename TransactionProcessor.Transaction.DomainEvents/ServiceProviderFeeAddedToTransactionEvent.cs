namespace TransactionProcessor.Transaction.DomainEvents
{
    ...
    [JsonObject]
    public class ServiceProviderFeeAddedToTransactionEvent : DomainEvent
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceProviderFeeAddedToTransactionEvent"/> class.
        /// </summary>
        [ExcludeFromCodeCoverage]
        public ServiceProviderFeeAddedToTransactionEvent()
        {
        }
        ...
        private ServiceProviderFeeAddedToTransactionEvent(Guid aggregateId,
                                                          Guid eventId,
                                                          Guid estateId,
                                                          Guid merchantId,
        ...
        /// <param name="feeValue">The fee value.</param>
        /// <returns></returns>
        public static ServiceProviderFeeAddedToTransactionEvent Create(Guid aggregateId,
                                                                       Guid estateId,
                                                                       Guid merchantId,
                                                                       Decimal calculatedValue,
                                                                       Int32 feeCalculationType,
                                                                       ...
                                                                       Decimal feeValue)
        {
            return new ServiceProviderFeeAddedToTransactionEvent(aggregateId, Guid.NewGuid(), estateId, merchantId, calculatedValue, feeCalculationType, feeId, feeValue);
        }
