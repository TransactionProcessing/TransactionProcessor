...
public class StatementBuilderTests
{
    ...
    public StatementBuilderTests()
    {
        ...
        // Setup statement aggregate and lines
        //var statement = new MerchantStatement();
        //statement.StatementDate = new DateTime(2024, 1, 1);
        //// Add two lines: one transaction, one fee
        //statement.GetType().GetField("StatementLines", BindingFlags.NonPublic | BindingFlags.Instance)
        //    .SetValue(statement, new Dictionary<int, MerchantStatementLine>
        //    {
        //        { 0, new MerchantStatementLine { DateTime = new DateTime(2024, 1, 1), Description = "Sale", Amount = 100m, LineType = 1 } },
        //        { 1, new MerchantStatementLine { DateTime = new DateTime(2024, 1, 1), Description = "Fee", Amount = -10m, LineType = 2 } }
        //    });

        //_statementAggregate = MerchantStatementAggregate.Create(Guid.NewGuid());
        //// Use reflection to set private field
        //_statementAggregate.GetType().GetField("MerchantStatementSummaries", BindingFlags.NonPublic | BindingFlags.Instance)
        //    .SetValue(_statementAggregate, new List<MerchantStatementSummary>());
        //_statementAggregate.GetType().GetField("StatementDate", BindingFlags.NonPublic | BindingFlags.Instance)
        //    .SetValue(_statementAggregate, statement.StatementDate);

        //// Mock GetStatement to return our statement
        //var getStatementMethod = _statementAggregate.GetType().GetMethod("GetStatement");
        //getStatementMethod.Invoke(_statementAggregate, null);
    ...
    public async Task GetStatementHtml_ThrowsIfTemplateMissing()
    {
        ...
        {
            await _builder.GetStatementHtml(merchantStatementAggregate, _merchant, _cancellationToken);
        });
    }
    ...
    public async Task GetStatementHtml_ThrowsIfMerchantAddressMissing()
    {
        ...
        {
            await _builder.GetStatementHtml(merchantStatementAggregate, merchant, _cancellationToken);
        });
    }
    ...
    public async Task GetStatementHtml_ThrowsIfMerchantContactMissing()
    {
        ...
        {
            MerchantName = TestData.Merchant.MerchantName,
            Addresses = _merchant.Addresses,
            Contacts = new List<Contact>() // No contact
        };
